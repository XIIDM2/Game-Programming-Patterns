        ...
        private void HandleAction(InputAction.CallbackContext context)
        {
            switch (context.action.name)
            {
                ...
                case "Jump":
                    ...
                    break;
                case "Crouch":
                    if (context.started) ActionTriggered?.Invoke(new InputData(PlayerAction.Crouch, null));
                    break;
                case "Attack":
                    if (context.started) ActionTriggered?.Invoke(new InputData(PlayerAction.Attack, null));
                    else if (context.canceled) ActionTriggered?.Invoke(new InputData(PlayerAction.StopAttack, null));
                    break;
            }
        }
